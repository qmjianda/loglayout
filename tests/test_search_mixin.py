...
def test_get_nearest_search_rank(bridge_instance, mock_session):
    ...
    assert bridge_instance.get_nearest_search_rank(file_id, 40, "next") == 0 # wrap around
    ...
    assert bridge_instance.get_nearest_search_rank(file_id, 10, "prev") == 3 # wrap around
